...
// charly's core (the pure RESOLUTION — TunnelConfigFromMetadata, the single tunnel-resolution
// entry point, + the schemeTarget/tailscaleFlag/isTCPFamily helpers the quadlet emitter
// shares — lives in sdk/deploykit/tunnel_resolve.go; charly/tunnel.go, the former core home,
// carried nothing but dead aliases and was deleted). It runs the actual
